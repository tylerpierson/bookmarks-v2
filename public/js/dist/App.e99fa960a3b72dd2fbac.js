...
function App() {
  ...
  const [duplicateUrl, setDuplicateUrl] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const login = async () => {
    try {
  ...
  }, "Logout") : '', duplicateUrl ? /*#__PURE__*/React.createElement("h1", null, "Bookmark already exists") : '', /*#__PURE__*/React.createElement(_components_Auth_Auth__WEBPACK_IMPORTED_MODULE_1__["default"], {
    login: login,
...
.lP8bUeE__NPUKEd25ulU .bbjbxRcitHlDD9VYLS1E {
  text-align: center;
  width: 50%;
  display: flex;
  flex-direction: column;
...
.lP8bUeE__NPUKEd25ulU h2 {
  color: white;
}`, "",{"version":3,"sources":["webpack://./src/components/BookmarkList/BookmarkList.module.scss"],"names":[],"mappings":"AAAA;EACI,iBAAA;EACA,kBAAA;EACA,UAAA;EACA,aAAA;EACA,uBAAA;EACA,uBAAA;AACJ;AAAI;EACI,kBAAA;EACA,UAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;AAER;AACI;EACI,YAAA;AACR","sourcesContent":[".container {\n    max-height: 470px;\n    overflow-y: scroll;\n    width: 50%;\n    display: flex;\n    justify-content: center;\n    align-items: flex-start;\n    .ul {\n        text-align: center;\n        width: 50%;\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n    }\n    \n    h2 {\n        color: white;\n    }\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
